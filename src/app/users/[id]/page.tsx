      ...
      <div className="card p-6 mt-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2">
          {client1RMs.map((rm) => (
            ...
            >
              <p className="text-[10px] text-zinc-400 truncate leading-tight">{rm.exercise_name}</p>
              {editing1RM ? (
                <div className="flex items-center gap-1 mt-1">
                  <input
                    ...
                    placeholder="0"
                    className="w-full px-1 py-0.5 bg-zinc-800 border border-zinc-700 rounded text-white text-sm font-bold focus:outline-none focus:ring-1 focus:ring-yellow-400"
                  />
                  <span className="text-zinc-500 text-[10px]">kg</span>
                </div>
              ) : (
                <p className={`text-base font-bold leading-tight ${rm.weight_kg > 0 ? 'text-white' : 'text-zinc-600'}`}>
